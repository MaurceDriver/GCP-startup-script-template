...
<body>
  <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
    ...
    <div class="w3-display-middle w3-center">
      <iframe src="<iframe src="https://giphy.com/embed/xTiTnkCSkEeBijjq00" width="480" height="259" style="" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/smoking-chris-tucker-friday-movie-xTiTnkCSkEeBijjq00">via GIPHY</a></p>"
              width="500"
              height="270"
      ...
      <h3 class="w3-large w3-center" style="margin-top:15px;">
        <a href="https://github.com/MaurceDriver/startup-script-template"
